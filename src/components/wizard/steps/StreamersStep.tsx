...
import { Search, Check, User, Users, Plus, X } from 'lucide-react';
...
function StreamerPicker({ streamers, selectedIds, onToggle }: StreamerPickerProps) {
  ...
  if (streamers.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-8 text-center border rounded-lg">
        ...
        <p className="text-sm text-muted-foreground">
          No streamers in database. Use manual entry below.
        </p>
      </div>
    );
  }
